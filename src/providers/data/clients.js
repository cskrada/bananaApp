...
var ClientsProvider = /** @class */ (function () {
    ...
    ClientsProvider.prototype.initializeItems = function () {
        this.items = [
            {
                id: '01',
                name: 'pepsico, CA',
    ...
    ClientsProvider.prototype.filterItems = function (searchTerm) {
    ...
    ClientsProvider.prototype.orderList = function (items) {
        this.filterItems;
